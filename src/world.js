(() => {
  const VERSION='11.7-core-consolidation';
  ...
  const OBJECT_START={foodPantry:{x:2,y:2},mealTray:{x:5,y:2},plateA:{x:5,y:2},plateB:{x:6,y:3},cupA:{x:6,y:2},cupB:{x:6,y:3},alcoholBottle:{x:5,y:3},waterBucket:{x:5,y:5},tap:{x:6,y:5}};
  ...
  function createInitialState(seed=20260911){
    ...
    const state={
      ...
      containers:{
        mealTray:{id:'mealTray',name:'現成食物',icon:'🍲',roles:roleList('readyFood'),capacity:100,emptyLoad:2.5,preferredResource:'food',contents:{food:68},portable:false,canEatFrom:true,access:1,position:{...OBJECT_START.mealTray},supportId:'diningTable',restock:{resource:'food',low:18,strategy:'carryResource',sourceRole:'foodReserve'}},
        plateA:{id:'plateA',name:'餐盤 A',icon:'🍽️',roles:roleList('servingDish'),capacity:12,emptyLoad:.35,contents:{},portable:true,servingDish:true,canEatFrom:true,position:{...OBJECT_START.plateA},supportId:'diningTable'},
        plateB:{id:'plateB',name:'餐盤 B',icon:'🍽️',roles:roleList('servingDish'),capacity:12,emptyLoad:.35,contents:{},portable:true,servingDish:true,canEatFrom:true,position:{...OBJECT_START.plateB},supportId:'diningTable'},
        foodPantry:{id:'foodPantry',name:'食物櫃',icon:'🧺',roles:roleList('foodReserve','externalSupplyDestination'),capacity:200,emptyLoad:8,preferredResource:'food',contents:{food:140},portable:false,access:1,position:{...OBJECT_START.foodPantry}},
