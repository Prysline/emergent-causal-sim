(() => {
  ...
  const ZH = {
    hunger:'飢餓', thirst:'口渴', fatigue:'疲勞', social:'社交', comfort:'舒適', safety:'安全感', cleanliness:'清潔',
  ...
  const DATA_ZH={action:'行動',amount:'數量',status:'狀態',value:'數值',successChance:'成功率',roll:'擲骰結果',reason:'原因',intoxication:'醉酒程度',coordination:'動作協調',transfer:'資源轉移',difficulty:'動作基準',environmentRisk:'環境風險',failRisk:'失敗風險',resource:'資源',from:'來源',to:'去向',container:'容器',source:'補給來源',location:'位置',target:'目標',noise:'噪音',phase:'階段'};
  ...
  function createInitialState(){
    ...
    return {
      ...
      containers:{
        ...
        cupA:{id:'cupA',name:'白色杯子',icon:'🥛',capacity:35,contents:{alcohol:20},location:'table',portable:true,canDrink:true,heldBy:null},
        cupB:{id:'cupB',name:'藍色杯子',icon:'🥛',capacity:35,contents:{},location:'table',portable:true,canDrink:true,heldBy:null},
        alcoholBottle:{id:'alcoholBottle',name:'酒瓶',icon:'🍾',capacity:160,preferredResource:'alcohol',contents:{alcohol:120},location:'table',portable:true,canDrink:false,heldBy:null}
      },
      sources:{tap:{id:'tap',name:'水龍頭',icon:'🚰',resource:'water',infinite:true,location:'sink'}},
      surfaces,
      endpointCauses:{}, locks:{}, noiseEvents:[],
      agents:{
        zhen:{id:'zhen',name:'阿真',kind:'human',location:'rest',needs:{hunger:34,thirst:29,fatigue:41,social:38,comfort:58,safety:80},status:{intoxication:0},contacts:{hands:{},feet:{}},causes:{intoxication:null,contacts:{hands:{},feet:{}}},traits:{alcoholLike:.25,social:.55,careful:.82},held:null,carrying:null,plan:null},
        zhou:{id:'zhou',name:'老周',kind:'human',location:'table',needs:{hunger:31,thirst:62,fatigue:46,social:24,comfort:55,safety:80},status:{intoxication:0},contacts:{hands:{},feet:{}},causes:{intoxication:null,contacts:{hands:{},feet:{}}},traits:{alcoholLike:.72,social:.32,careful:.48},held:null,carrying:null,plan:null},
        orange:{id:'orange',name:'橘子',kind:'cat',location:'doorway',needs:{hunger:26,thirst:22,fatigue:30,social:28,comfort:70,safety:82,cleanliness:75},status:{intoxication:0},contacts:{paws:{}},causes:{intoxication:null,contacts:{paws:{}}},traits:{curious:.7,careful:.62,social:.78},held:null,carrying:null,plan:null}
      },
