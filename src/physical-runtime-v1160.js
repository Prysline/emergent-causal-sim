(() => {
  ...
  function getLocomotionProfile(agent,mode='standing'){
  ...
  function getMovementEnvelope(agent,mode='standing'){
  ...
  function requiredClearance(agent,mode='standing'){return getMovementEnvelope(agent,mode)?.clearanceHeight??null;}

  Object.assign(P,{VERSION,getPhysicalProfile,getLocomotionProfile,getMovementEnvelope,requiredClearance});
