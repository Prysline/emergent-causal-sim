(() => {
  ...
  const VERSION='11.16.0-physical-profile-foundation';
  ...
  const DEFAULT_PHYSICAL_PROFILES=Object.freeze({
    human:Object.freeze({
      ...
      locomotionCapabilities:Object.freeze({standing:true}),
      locomotionProfiles:Object.freeze({standing:Object.freeze({heightFactor:1,widthFactor:1,lengthFactor:1,speedFactor:1})})
    }),
    cat:Object.freeze({
      mass:4.5,
      volume:.0045,
