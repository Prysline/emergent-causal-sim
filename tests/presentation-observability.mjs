...
const CURRENT_VERSION='11.29.2-batch-step-yielding';
...
assert.match(indexSource,/v11\.29\.2・Batch Step Yielding/,'app shell must expose the current short version and feature label');
