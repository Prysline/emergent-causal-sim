...
for(const file of ['furniture-definitions.js','horizontal-geometry.js','world-authoring.js','embodiment-capabilities.js','world-initializer.js']){
...
assert.equal(imported.authoringSchema,'world-authoring-v7');
assert.equal(imported.furnitureCatalogVersion,'furniture-definitions-v7');
...
assert.ok(editorHtml.includes('世界建構 · world-authoring-v7'));
