...
assert.equal(st.version,'11.27.1-resident-private-badge','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.27.1-resident-private-badge');
