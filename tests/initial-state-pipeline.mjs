...
assert.equal(st.version,'11.29.2-batch-step-yielding','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.29.2-batch-step-yielding');
