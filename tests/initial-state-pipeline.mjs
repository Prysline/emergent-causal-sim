...
assert.equal(st.version,'11.26.0-vertical-structure-traversal','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.26.0-vertical-structure-traversal');
