...
assert.equal(st.version,'11.29.1-slot-interaction-egress','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.29.1-slot-interaction-egress');
