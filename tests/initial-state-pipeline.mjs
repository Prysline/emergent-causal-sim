...
assert.equal(st.version,'11.29.3-interaction-winner-result-reuse','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.29.3-interaction-winner-result-reuse');
