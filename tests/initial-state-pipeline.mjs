...
assert.equal(st.version,'11.31.1-autoplay-completion-aware','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.31.1-autoplay-completion-aware');
