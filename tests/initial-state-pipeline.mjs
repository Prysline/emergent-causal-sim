...
assert.equal(st.version,'11.27.2-room-value-legacy-removal','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.27.2-room-value-legacy-removal');
