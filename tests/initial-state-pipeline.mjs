...
assert.equal(st.version,'11.27.0-furniture-orientation','full production schema set must preserve current release marker');
...
assert.equal(customState.version,'11.27.0-furniture-orientation');
