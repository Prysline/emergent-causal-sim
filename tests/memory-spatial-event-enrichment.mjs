...
loadRuntimeProfile([
  ...
  'systems/memory/state.js','systems/appraisal/state.js',
  'engine.js','runtime-hook-pipeline.js','spatial-runtime-effects.js','systems/memory/runtime.js','systems/appraisal/runtime.js'
]);
