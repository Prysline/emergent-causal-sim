...
for(const file of ['furniture-definitions.js','horizontal-geometry.js','world-authoring.js','embodiment-capabilities.js','editor-authoring-mutations.js','world-initializer.js']){
...
}
{
  ...
  assert.deepEqual(result.candidate.furniture['chair-basic-1'],{id:'chair-basic-1',definitionId:'chair-basic',origin:{x:3,y:4,z:0},orientation:'south'});
