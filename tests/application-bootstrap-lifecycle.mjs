...
const previewAuthoring={authoringSchema:'world-authoring-v5',furnitureCatalogVersion:'furniture-definitions-v3',map:{width:1,height:1,cellSizeMeters:1,layers:[{z:0,cells:{},boundaries:{}}]},doors:{},exits:{}};
