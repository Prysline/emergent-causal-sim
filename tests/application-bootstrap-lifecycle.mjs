...
const previewAuthoring={authoringSchema:'world-authoring-v4',furnitureCatalogVersion:'furniture-definitions-v2',map:{width:1,height:1,cellSizeMeters:1,layers:[{z:0,cells:{},boundaries:{}}]},doors:{},exits:{}};
