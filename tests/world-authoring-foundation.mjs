...
const st=I.createInitialState(authored,{seed:20260911,version:'11.28.2-preview-boundary-presentation'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.28.2-preview-boundary-presentation'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.28.2-preview-boundary-presentation'});
