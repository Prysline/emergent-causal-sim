...
const st=I.createInitialState(authored,{seed:20260911,version:'11.30.0-metric-route-locomotion'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.30.0-metric-route-locomotion'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.30.0-metric-route-locomotion'});
