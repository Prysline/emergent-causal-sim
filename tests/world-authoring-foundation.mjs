...
const st=I.createInitialState(authored,{seed:20260911,version:'11.29.3-interaction-winner-result-reuse'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.29.3-interaction-winner-result-reuse'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.29.3-interaction-winner-result-reuse'});
