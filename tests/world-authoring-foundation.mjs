...
const st=I.createInitialState(authored,{seed:20260911,version:'11.23.1-editor-source-port-observability'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.23.1-editor-source-port-observability'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.23.1-editor-source-port-observability'});
