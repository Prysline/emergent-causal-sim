...
const st=I.createInitialState(authored,{seed:20260911,version:'11.29.2-batch-step-yielding'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.29.2-batch-step-yielding'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.29.2-batch-step-yielding'});
