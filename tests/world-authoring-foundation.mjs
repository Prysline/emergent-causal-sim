...
const st=I.createInitialState(authored,{seed:20260911,version:'11.31.0-crowding-8-direction'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.31.0-crowding-8-direction'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.31.0-crowding-8-direction'});
