...
const st=I.createInitialState(authored,{seed:20260911,version:'11.29.0-horizontal-geometry-foundation'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.29.0-horizontal-geometry-foundation'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.29.0-horizontal-geometry-foundation'});
