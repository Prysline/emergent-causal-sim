...
const st=I.createInitialState(authored,{seed:20260911,version:'11.31.1-autoplay-completion-aware'});
...
const again=I.createInitialState(authored,{seed:20260911,version:'11.31.1-autoplay-completion-aware'});
assert.deepEqual(again,st,'same package + same seed must produce the same raw compiled state');
const otherSeed=I.createInitialState(authored,{seed:7,version:'11.31.1-autoplay-completion-aware'});
