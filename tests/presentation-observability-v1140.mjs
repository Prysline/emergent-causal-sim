...
assert.equal(globalThis.SimCrowding.VERSION,CURRENT_VERSION);
assert.equal(globalThis.SimSpatial.CROWDING_VERSION,CURRENT_VERSION);
...
assert.match(indexSource,/v11\.20\.0・Dynamic Congestion/,'app shell must expose the current short version and feature label');
