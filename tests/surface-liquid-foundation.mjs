...
for(const file of ['world-authoring.js','world-initializer.js','world.js','release.js','spatial.js','spatial-traversal.js','spatial-observability.js','spatial-contact.js','spatial-floor-effects.js','spatial-surface-environment.js','engine.js','runtime-hook-pipeline.js','spatial-runtime-effects.js','state-validator.js','state-validator-v111.js','state-validator-v1114.js']){
