...
loadRuntimeProfile(['world-authoring.js','world-initializer.js','world.js','release.js','spatial.js','spatial-traversal.js','spatial-observability.js','spatial-contact.js','engine.js','validation/registry.js','validation/rules/spatial-node.js']);
...
E.reset(20260911);
{
  ...
  assert.equal(E.VERSION,'11.24.0-locomotion-traversal-cost');
