...
for(const file of ['world-authoring.js','world-initializer.js','world.js','release.js','spatial.js','spatial-v111.js','engine.js','state-validator.js','state-validator-v111.js']){
